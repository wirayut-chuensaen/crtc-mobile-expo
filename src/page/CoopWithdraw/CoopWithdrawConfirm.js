...
import { AppButton, AppView, SizedBox, StepBar } from '../../component';
import { transferWithdrawConfirm, transferWithdrawConfirmOtp } from "../../service/Services"
import toCurrency from '../../utils/toCurrency';

const CoopWithdrawConfirm = ({ navigation, Actions, remark, info = {}, amount, subscribe = false }) => {
	const [isLoading, setIsLoading] = useState(false);

	const onConfirm = async () => {
		try {
			setIsLoading(true)
			await transferWithdrawConfirm({ amount, remark }, (res, done) => {
			...
			console.log("CoopWithdrawConfirm.js onConfirm error : ", e)
		} finally {
			setIsLoading(false)
		}
	}
