...
const CoopDepositSuccess = ({navigation, Actions, refresh, amount, remark, subscribe = false, info = {}, successData = {}}) => {
        ...
        <KeyboardAwareScrollView showsVerticalScrollIndicator={false}>
          <View>
            ...
            <View style={styles.center}>
              <Text style={styles.label}>ดำเนินการฝากสำเร็จ</Text>
              <SizedBox height={20} />
...
CoopDepositSuccess.defaultProps = {};

export default useNavigator(CoopDepositSuccess);
