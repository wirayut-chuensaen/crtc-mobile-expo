...
const CoopLoanSuccess = ({navigation, Actions, refresh, amount, remark, subscribe = false, info = {}, successData = {}}) => {
        ...
        <KeyboardAwareScrollView showsVerticalScrollIndicator={false}>
          <View>
            ...
            <View style={styles.center}>
              <Text style={styles.label}>ดำเนินการกู้เงินสำเร็จ</Text>
              <SizedBox height={20} />
...
CoopLoanSuccess.defaultProps = {};

export default useNavigator(CoopLoanSuccess);
