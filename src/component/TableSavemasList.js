...
const TableSavemasList = ({data, header = [], footer = []}) => {
  const _renderItem = ({item, index}) => {
    ...
    return (
      <View style={styles.tbody}>
        ...
        <View style={styles.td}>
          <Text style={styles.tdText}>{item.data_note}</Text>
        </View>
        <View style={styles.td}>
  ...
  const buildListHeader = () => (
    <View key="header" style={styles.headerContainer}>
      ...
      <View style={styles.thead}>
        ...
        <View style={styles.th}>
          <Text style={styles.thText}>เลขบัญชี</Text>
        </View>
        <View style={styles.th}>
...
TableSavemasList.defaultProps = {
  data: [],
};

export default TableSavemasList;
